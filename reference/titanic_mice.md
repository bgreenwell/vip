...
The [titanic](https://bgreenwell.github.io/vip/reference/titanic.md)
...
contained in the
[titanic](https://bgreenwell.github.io/vip/reference/titanic.md) data
frame; each completed data set has the same dimension and column
structure as
[titanic](https://bgreenwell.github.io/vip/reference/titanic.md).
