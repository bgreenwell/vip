...
- Fixed ggplot class testing for ggplot2 S7 compatibility
  [(](https://github.com/koalaverse/vip/issues/162)[\#162](https://github.com/koalaverse/vip/issues/162)).
...
- Updated branch references from `master` to `main` throughout the
  ...
  [(](https://github.com/koalaverse/vip/pull/164)[\#164](https://github.com/koalaverse/vip/issues/164)).
...
- [`vi_model()`](https://koalaverse.github.io/vip/reference/vi_model.md)
  ...
  suggestion
  [(](https://github.com/koalaverse/vip/issues/146)[\#146](https://github.com/koalaverse/vip/issues/146)).
...
- Added support for partial least squares via the
  ...
  [\#129](https://github.com/koalaverse/vip/issues/129)); thanks to
...
- Added support for the
  ...
  [\#128](https://github.com/koalaverse/vip/issues/128)); thanks to
  [@topedo](https://github.com/topedo).
...
- Removed deprecated arguments from
  [`vip()`](https://koalaverse.github.io/vip/reference/vip.md); in
  particular, `bar`, `width`, `alpha`, `color`, `fill`, `size`, and
  `shape`. Users should instead rely on the `mapping` and `aesthetics`
  arguments; see
  [`?vip::vip`](https://koalaverse.github.io/vip/reference/vip.md) for
  details.
...
- Fixed a couple bugs that occurred when using
  ...
  [(](https://github.com/koalaverse/vip/issues/103)[\#103](https://github.com/koalaverse/vip/issues/103)).
...
- Added a CITATION file and PDF-based vignette based off of the
  ...
  [(](https://github.com/koalaverse/vip/issues/109)[\#109](https://github.com/koalaverse/vip/issues/109)).
...
- Switch from
  ...
  [(](https://github.com/koalaverse/vip/issues/101)[\#101](https://github.com/koalaverse/vip/issues/101)).
...
- Added support for SHAP-based feature importance which makes use of the
  ...
  [`vip()`](https://koalaverse.github.io/vip/reference/vip.md) and
  specify `method = "shap"`, or you can just call
  [`vi_shap()`](https://koalaverse.github.io/vip/reference/vi_shap.md)
  directly
  [(](https://github.com/koalaverse/vip/issues/87)[\#87](https://github.com/koalaverse/vip/issues/87)).
...
- Added support for the
  ...
  [(](https://github.com/koalaverse/vip/issues/94)[\#94](https://github.com/koalaverse/vip/issues/94)).
...
- Added support for `"mvr"` objects from the
  ...
  [(](https://github.com/koalaverse/vip/issues/35)[\#35](https://github.com/koalaverse/vip/issues/35)).
...
- The `"lm"` method for
  ...
  [(](https://github.com/koalaverse/vip/issues/77)[\#77](https://github.com/koalaverse/vip/issues/77)).

- New function
  [`gen_friedman()`](https://koalaverse.github.io/vip/reference/gen_friedman.md)
...
- The [`vip()`](https://koalaverse.github.io/vip/reference/vip.md)
  ...
  [(](https://github.com/koalaverse/vip/issues/79)[\#79](https://github.com/koalaverse/vip/issues/79)).
...
- The [`vip()`](https://koalaverse.github.io/vip/reference/vip.md)
  ...
  [(](https://github.com/koalaverse/vip/issues/80)[\#80](https://github.com/koalaverse/vip/issues/80)).
...
- Removed dependency on
  ...
  [(](https://github.com/koalaverse/vip/issues/93)[\#93](https://github.com/koalaverse/vip/issues/93)).

- Switched to the
  [tinytest](https://cran.r-project.org/package=tinytest) framework
  [(](https://github.com/koalaverse/vip/issues/82)[\#82](https://github.com/koalaverse/vip/issues/82)).
...
- [`vi_model()`](https://koalaverse.github.io/vip/reference/vi_model.md)
  ...
  [(](https://github.com/koalaverse/vip/issues/74)[\#74](https://github.com/koalaverse/vip/issues/74)).

- Added appropriate **sparklyr** version dependency
  [(](https://github.com/koalaverse/vip/issues/59)[\#59](https://github.com/koalaverse/vip/issues/59)).
...
- [`vi_permute()`](https://koalaverse.github.io/vip/reference/vi_permute.md)
  ...
  [`vi()`](https://koalaverse.github.io/vip/reference/vi.md) or
  [`vip()`](https://koalaverse.github.io/vip/reference/vip.md) as well.
...
- `add_sparklines()` creates an HTML widget to display variable
  ...
  [(](https://github.com/koalaverse/vip/issues/64)[\#64](https://github.com/koalaverse/vip/issues/64)).

- Added support for the Olden and Garson algorithms with neural networks
  fit using the **neuralnet**, **nnet**, and **RSNNS** packages
  [(](https://github.com/koalaverse/vip/issues/28)[\#28](https://github.com/koalaverse/vip/issues/28)).
...
- [`vip()`](https://koalaverse.github.io/vip/reference/vip.md) gained
...
- Added `nsim` argument to
  ...
  predictor
  [(](https://github.com/koalaverse/vip/issues/36)[\#36](https://github.com/koalaverse/vip/issues/36)).

- Added `sample_size` and `sample_frac` arguments to
  [`vi_permute()`](https://koalaverse.github.io/vip/reference/vi_permute.md)
  for reducing the size of the training sample for every Monte Carlo
  repetition
  [(](https://github.com/koalaverse/vip/issues/41)[\#41](https://github.com/koalaverse/vip/issues/41)).
...
- New argument `rank`, which defaults to `FALSE`, available in
  [`vi()`](https://koalaverse.github.io/vip/reference/vi.md)
  [(](https://github.com/koalaverse/vip/issues/55)[\#55](https://github.com/koalaverse/vip/issues/55)).

- Added support for Spark (G)LMs.

- [`vi()`](https://koalaverse.github.io/vip/reference/vi.md) is now a
...
- Fixed bug in `get_feature_names.ranger()` s.t. it never returns
  ...
  [(](https://github.com/koalaverse/vip/issues/43)[\#43](https://github.com/koalaverse/vip/issues/43)).

- Added `pkgdown` site: <https://github.com/koalaverse/vip>.

- Changed `truncate_feature_names` argument of
  [`vi()`](https://koalaverse.github.io/vip/reference/vi.md) to
  `abbreviate_feature_names` which abbreviates all feature names, rather
  than just truncating them.

- Added CRAN-related badges
  [(](https://github.com/koalaverse/vip/issues/32)[\#32](https://github.com/koalaverse/vip/issues/32)).

- New generic
  [`vi_permute()`](https://koalaverse.github.io/vip/reference/vi_permute.md)
  for constructing permutation-based variable importance scores
  [(](https://github.com/koalaverse/vip/issues/19)[\#19](https://github.com/koalaverse/vip/issues/19)).

- Fixed bug and unnecessary error check in `vint()`
  [(](https://github.com/koalaverse/vip/issues/38)[\#38](https://github.com/koalaverse/vip/issues/38)).
...
- [`vip()`](https://koalaverse.github.io/vip/reference/vip.md) gained a
...
- [`vi()`](https://koalaverse.github.io/vip/reference/vi.md) gained
...
- [`vi_model.lm()`](https://koalaverse.github.io/vip/reference/vi_model.md),
  and hence [`vi()`](https://koalaverse.github.io/vip/reference/vi.md),
  contains an additional column called `Sign` that contains the sign of
  the original coefficients
  [(](https://github.com/koalaverse/vip/issues/27)[\#27](https://github.com/koalaverse/vip/issues/27)).

- [`vi()`](https://koalaverse.github.io/vip/reference/vi.md) gained a
  new argument, `scale`, for scaling the variable importance scores so
  that the largest is 100. Default is `FALSE`
  [(](https://github.com/koalaverse/vip/issues/24)[\#24](https://github.com/koalaverse/vip/issues/24)).

- [`vip()`](https://koalaverse.github.io/vip/reference/vip.md) gained
  two new arguments, `size` and `shape`, for controlling the size and
  shape of the points whenever `bar = FALSE`
  [(](https://github.com/koalaverse/vip/issues/9)[\#9](https://github.com/koalaverse/vip/issues/9)).

- Added support for `"H2OBinomialModel"`, `"H2OMultinomialModel"`, and,
  `"H2ORegressionModel"` objects
  [(](https://github.com/koalaverse/vip/issues/8)[\#8](https://github.com/koalaverse/vip/issues/8)).
